...
class TestLiteLLMProviderErrorHandling:
    ...
    @pytest.mark.skip(reason="LiteLLM exception mocking requires complex setup, tested in integration tests")
    def test_authentication_error(self, mock_provider_config: ProviderConfig) -> None:
        ...
        complex httpx Response/Request objects. The error handling is tested in actual
        integration tests where real LiteLLM exceptions are raised.
        """
        pass
